...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    println!("cargo:rerun-if-changed=../../../proto/reranker/reranker.proto");
    ...
    let reranker_proto = manifest_dir.join("../../../proto/reranker/reranker.proto");
    ...
    tonic_prost_build::configure()
        .build_server(false)
        .compile_protos(
            &[speech_proto, embeddings_proto, reranker_proto],
            &[proto_dir],
        )?;
